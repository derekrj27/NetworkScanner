...
if response == '1':
    ...
    logging.debug(scanner.scaninfo())
    # state() tells if target is up or down
    print("Ip Status: ", scanner[ip_addr].state())
    logging.debug(scanner[ip_addr].state())
    ...
    #logging.debug("protocols:",scanner[ip_addr].all_protocols())
    print("Open Ports: ", scanner[ip_addr]['tcp'].keys())
    logging.debug(scanner[ip_addr]['tcp'].keys())
    #logging.debug("Open Ports: ", scanner[ip_addr]['tcp'].keys())
